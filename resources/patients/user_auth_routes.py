...
from schemas import UserModelSchema, AuthUserModelSchema
from . import bp
from .UserModel import UserModel


@bp.route('/register', methods=['POST'])
@bp.arguments(UserModelSchema)
@bp.response(201, UserModelSchema)
def register_user(user_data): #post user through auth reg instead of routes
  user = UserModel()
